...
| [0007](0007-terminal-console-overlay.md) | Phase 4 Ship A — terminal console overlay *(planned)* |
| [0008](0008-terminal-console-games-snake.md) | Phase 4 Ship B — snake mini-game *(planned)* |
